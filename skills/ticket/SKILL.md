...
### Create ticket
```bash
tk create "Fix auth timeout" -t bug -p 1 -d "Users get logged out after 5 min"
tk create "Add dark mode" -t feature --acceptance "Toggle in settings; persists across sessions"
```
